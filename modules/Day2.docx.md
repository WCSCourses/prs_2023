...
---
     ...
     > non-effect allele. For example, in the height GWAS conducted by the GIANT consortium, 
     > the effect allele is in the column Allele1, while Allele2 represents the non-effect allele.
