...
>  ```
>  
>  Take some time to have a look through some of thses user options. By looking at the uber options, work out which user option or options were used to ensure that the command above only calculated 1 PRS at genome-wide significance of \< 5*×*10<sup>−8</sup>.
>  
---
...
![Figure 1.1](/images/Day2.docx_folder/images-018.png){:height="100px" width="100px"}
...
```
 ...
 When PRSice performs high-resolution scoring, it will generate a plot ([Figure 1.2](#_bookmark15)) presenting the model fit of PRS calculated at all P-value thresholds.
>
   **Figure 1.2: High resolution Plot generated by PRSice**
![Figure 1.2](/images/Day2.docx_folder/images-022.png)
...
>
>❓The default of PRSice is to iterate the P-value threshold from \< 5*×*10<sup>−8</sup> to 0.5 with a step aize of 0.00005, and to inlcude the P-value threshold of 1. Can you identify the commands controlling these parameters?
>
---
<a href="#top">Back to top</a>
...
---
> 
> ℹ️ Usually, Principal Components (PCs) are also included as covariates in the analysis to account for population structure and it can be tedious to type all 20 or 40 PCs (e.g. *PC1*, *PC2*,...,*PC20*). In PRSice, you can add @ in front of the *--cov-col* string to activate the automatic substitution of numbers. If @ is found in front of the *--cov-col* string, any numbers within **\[** and **\]** will be parse. E.g. @PC\[1-3] will be read as *PC1*, *PC2*, *PC3*. Discontinuous input are also supported: @cov\[1.3-5] will be parsed as *cov1*, *cov3*, *cov4*, *cov5*. You can also mix it up, e.g. @PC\[1-3]. Sex will be interpreted as *PC1*, *PC2*, *PC3*, *Sex* by PRSice.
>
---
>
